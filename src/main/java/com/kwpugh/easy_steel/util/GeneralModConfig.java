...
public class GeneralModConfig
{
    ...
    public static void init(ForgeConfigSpec.Builder SERVER_BUILDER)
    {
        ...
        BORNITE_ORE_CHANCE = SERVER_BUILDER.comment("Chances of Bornite Ore pocket being generated [0-100, default: 20]").defineInRange("borniteOreChance", 20, 0, 100);
        ...
        CASSITERITE_ORE_CHANCE = SERVER_BUILDER.comment("Chances of Cassiterite Ore pocket being generated [0-100, default: 20]").defineInRange("cassiteriteOreChance", 20, 0, 100);
