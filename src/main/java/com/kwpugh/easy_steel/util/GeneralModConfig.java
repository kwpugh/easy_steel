...
public class GeneralModConfig
{
    ...
    public static void init(ForgeConfigSpec.Builder SERVER_BUILDER)
    {
        ...
        WOLFRAMITE_ORE_CHANCE = SERVER_BUILDER.comment("Chances of Wolframite Ore pocket being generated [0-100, default: 8]").defineInRange("wolframiteOreChance", 8, 0, 100);
        ...
        WOLFRAMITE_ORE_MAX_HEIGHT = SERVER_BUILDER.comment("Maximal height for Wolframite Ore pocket generation [0-255, default: 200]").defineInRange("wolframiteOreMaxHeight", 16, 0, 255);
