...
public class HardenedSteelBow extends BowItem
{
   public HardenedSteelBow(Item.Properties builder)
   {
      super(builder);
   ...
   public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag flag)
   {
	   ...
	   list.add(new StringTextComponent(TextFormatting.GREEN + "An even more durable bow"));
   } 
}