...
public class SteelTridentEntity extends AbstractArrowEntity {
   private static final DataParameter<Byte> LOYALTY_LEVEL = EntityDataManager.createKey(SteelTridentEntity.class, DataSerializers.BYTE);
   private static final DataParameter<Boolean> field_226571_aq_ = EntityDataManager.createKey(SteelTridentEntity.class, DataSerializers.BOOLEAN);
   private ItemStack thrownStack = new ItemStack(ItemList.steel_trident);
   private boolean dealtDamage;
   public int returningTicks;

   public SteelTridentEntity(EntityType<? extends SteelTridentEntity> type, World worldIn) {
      super(type, worldIn);
   }

   public SteelTridentEntity(World worldIn, LivingEntity thrower, ItemStack thrownStackIn) {
   ...
   @OnlyIn(Dist.CLIENT)
   public SteelTridentEntity(World worldIn, double x, double y, double z) {
