...
//	        icrossbowuser.shoot(icrossbowuser.getAttackTarget(), crossbow, projectileentity, projectileAngle);
//	     }
//	     else
//	     {
...
//		tooltip.add((new TranslationTextComponent("item.easy_steel.crossbow.line1").func_240699_a_(TextFormatting.GREEN)));
//		tooltip.add((new TranslationTextComponent("item.easy_steel.crossbow.line2").func_240699_a_(TextFormatting.AQUA)));
//	}
//}